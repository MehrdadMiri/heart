"""
Django settings for heartdoc project.
...
SECRET_KEY = 'django-insecure-g$ptzill4%bsca3^@1s&nxs2$yg7&xwe_e5!gcn0)1*=vppqs-'
...
WSGI_APPLICATION = 'heartdoc.wsgi.application'
